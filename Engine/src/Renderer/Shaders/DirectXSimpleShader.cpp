...
namespace Engine
{
	DirectXSimpleShader::DirectXSimpleShader(const std::vector<D3D12_INPUT_ELEMENT_DESC>& pLayout,
	...
	void DirectXSimpleShader::InitializePipelineState(std::vector<D3D12_INPUT_ELEMENT_DESC> pLayout,
